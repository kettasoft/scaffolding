@if(auth()->user()->hasPermission('delete_admins') && auth()->user()->isNot($admin))

    <a href="#admin-{{ $admin->id }}-delete-model" class="btn btn-outline-danger btn-sm"
       data-toggle="modal">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="modal-title-{{ $admin->id }}">@lang('accounts::admins.dialogs.delete.title')</h5>
