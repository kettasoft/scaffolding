...
let PUSHER_APP_ENCRYPTED = document.head.querySelector('meta[name="PUSHER_APP_ENCRYPTED"]');
...
window.Echo = new Echo({
    ...
    useTLS: PUSHER_APP_ENCRYPTED ? PUSHER_APP_ENCRYPTED.content : process.env.MIX_PUSHER_APP_ENCRYPTED,
    disableStats: true,
    forceTLS: true,
