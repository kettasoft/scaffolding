                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        ...
                                        <div class="text-center">
                                            <h2 class="mb-4 text-danger fw-bolder">Request Rejected</h2>
                                            <p class="mb-1">Your Submission Could Not Be Approved!</p>
                                            <a class="text-primary d-block">Rejection details</a>
                                            <img src="{{ asset('images/backgrounds/rejected.svg') }}" alt="">

                                            <div class="form">
                                                <a class="btn btn-secondary w-100"
                                                    href="{{ route('dashboard.rejected.edit', auth()->user()) }}">Edit Your
                                                    account</a>
                                            </div>
                                        </div>
                                        {{-- Form --}}
